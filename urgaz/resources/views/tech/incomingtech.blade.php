...
<div id="notification-container"></div>
          ...
          <form action="{{ url('customerlist/save_tech')}}" method="POST" id="myForm">
              @csrf
              <h4 class="text-center mb-4">Texnika qo'shish </h4>
              ...
              <div class="form-row mb-3">
                <div class="input-group">
                  ...
                  <input type="checkbox" id="qqs-active" class="form-control col-md-1" onchange="calculate()" >
                </div>
              </div>
              <div class="form-row mb-3">
                <div class="input-group">
...
<script>
  function calculate(){
    ...
    var total= number*(price+price*nds/100);
    $('#total').val(total);
  }
...
//             $("#price").val(data[0].volume*data[0].price);
