...
@section('content')
    ...
    <div class="wrapper">
        <div class="tabs">
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-1" checked class="tab-switch" onclick="location.href='{{route('returns.index')}}'">
            <label for="tab-1" class="tab-label">Qaytgan tovarlar</label>
          ...
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-2" class="tab-switch" onclick="location.href='{{ url('returns/create2') }}'">
            <label for="tab-2" class="tab-label"> Gilamga qo'shish</label>
          ...
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-3" class="tab-switch" onclick="location.href='{{ route('returns.create')}}'">
            <label for="tab-3" class="tab-label">Texnikaga qo'shish </label>
