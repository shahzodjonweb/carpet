                    ...
                    <div class='col-7 row'>
                        <div class="col-4">
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input oninput="paymentControl()" type="number" class="form-control" id="number" name="number" value=1>
                                  </div>
                              </div>
                        </div>
                        <div class="col-8">
...
<div class="container">
    ...
    <div class="alert alert-warning">
        ...
        <div class="row">
            ...
            <div class="col-7"> ( {{$product->number}} Dona ) </div>
        </div>
        @endforeach
    </div>
   ...
   <script>
        ...
        if(mainId>1){
            for (let index = 2; index <= mainId; index++) {
                sum+=parseInt($('#number'+(index-1)).val())*parseInt($('#price'+(index-1)).val());
                console.log(sum);
            }
        }
       ...
       function addProduct(){
var mainId=parseInt($('#lastid').val());
htmlContent='<div class="pr'+mainId+' myproducts row my-2"><div class="col-7 row"><div class="col-4"><div class="form-group row"><label for="number" class="col-4 col-form-label text-make-dark">Soni:</label><div class="col-8"><input oninput="paymentControl()" type="number" class="form-control" id="number'+mainId+'" name="number'+mainId+'" value=1></div></div></div><div class="col-8"><div class="form-group row"><label for="price" class="col col-form-label text-make-dark">Narxi(dona/narx):</label><div class="col"><input oninput="paymentControl()" type="number" class="form-control" id="price'+mainId+'" name="price'+mainId+'" value=0></div></div></div></div><div class="col-5"> <div class="form-group row"> <label for="payment_type" class="col-3 col-form-label text-make-dark">Maxsulot:</label><div class="col-9"><input type="text" list="products" class="form-control input-sm" id="productname'+mainId+'" name="productname'+mainId+'" required /><datalist id="products" >'
                                      @foreach ($products as $item)
                                        +'<option value="{{$item->productname}}">{{$item->number}}</option>'
                                      @endforeach
