...
Route::post('analize/fastpayment', 'AnalizeController@fastpayment')->middleware('auth');
Route::get('analize/situation', 'AnalizeController@payment_situation')->middleware('auth');
...
Route::resource('distributor', 'DistributorsController')->middleware('auth');
