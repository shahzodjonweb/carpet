...
<div class="col-md-8 mx-auto px-5 py-3 credit-form">
    <form action="{{url('customerlist/credit_save_tech')}}" method="POST" enctype="multipart/form-data" id="myForm">
        @csrf
  ...
  @endif
      ...
      <div class="form-row mb-3">
        <div class="input-group">
          <label for="model" class="col-md-4 mt-2"
            >Mahsulot modeli <span class="text-danger">*</span></label
          >
          <input
          type="text"
          id="model"
