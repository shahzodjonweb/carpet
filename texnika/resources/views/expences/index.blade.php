        ...
        <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 p-0 mx-1">
                  <select class="form-control" id="expence_type"  name="expence_type">
                    <option  value=""><b>Xarajat turi</b></option>
                    <option  value="Asosiy vosita"><b>Asosiy vosita</b></option>
                      <option value="Kommunal Xarajatlar">Kommunal Xarajatlar</option>
                      <option value="Mobil Aloqa">Mobil Aloqa</option>
                      <option value="Internet">Internet</option>
                      <option  value="Oziq Ovqat">Umumiy Ovqatlanish</option>
                      <option  value="Ish haqi">Ish haqi</option>
                      <option value="discount">Chegirmalar</option>
                      <option value="returned">Qaytgan tovarlar</option>
              ...
              <div class="col-lg-2 col-md-2 col-sm-12 p-0 mx-1">
                  ...
                  <div class="col-3 row text-right ml-4">
       
                    <button type="button" class="col-5 plus-button" onclick="showmodal()">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('expences.store') }}">
                ...
                <div class="form-group row">
                    <label for="category" class="col-sm-2 col-form-label">Turi</label>
                    <div class="col-sm-10">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('expences.store') }}">
                ...
                <div class="form-group row">
                    <label for="category_edit" class="col-sm-2 col-form-label">Turi</label>
                    <div class="col-sm-10">
                        <select class="form-control" id="category_edit"  name="category_edit">
                            <option value="Kommunal Xarajatlar">Kommunal Xarajatlar</option>
                            <option value="Mobil Aloqa">Mobil Aloqa</option>
                            <option value="Internet">Internet</option>
                            <option  value="Umumiy Ovqatlanish">Umumiy Ovqatlanish</option>
                            <option  value="Kredit So'ndirish">Kredit So'ndirish</option>
                            <option value="Boshqa xarajatlar">Boshqa xarajatlar</option>
                          </select>
                    </div>
                  </div>
                ...
                <div class="form-group">
                    <label for="comment_edit">Kommentariya</label>
                    <textarea class="form-control" id="comment_edit" name="comment_edit" rows="3"></textarea>
                  </div>
                <div class="form-group row">
                  <label for="price_edit" class="col-sm-2 col-form-label">Narx</label>
                  <div class="col-sm-10">
