...
@section('content')
    ...
    <div class="wrapper">
        <div class="tabs">
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-1" checked class="tab-switch" onclick="location.href='{{ url('customer_ac/discountitem') }}'">
            <label for="tab-1" class="tab-label">Kartalar ro'yxati</label>
          ...
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-2" class="tab-switch" onclick="location.href='{{ url('customer_ac/discountget') }}'">
            <label for="tab-2" class="tab-label">Kartadan pul yechish</label>
          ...
          <div class="tab">
            ...
            <label for="tab-3" class="tab-label">Registratsiya</label>
