...
@section('content')
    ...
    <div class="wrapper">
        <div class="tabs">
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-1" checked class="tab-switch" onclick="location.href='{{ route('analize.index') }}'">
          ...
          <div class="tab">
            ...
            <label for="tab-3" class="tab-label">Kredit Gilam</label>
          ...
          <div class="tab">
            <input type="radio" name="css-tabs" id="tab-4" class="tab-switch" onclick="location.href='{{route('customerlist.create')}}'">
