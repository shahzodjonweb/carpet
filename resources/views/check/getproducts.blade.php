...
<div id="notification-container"></div>
          ...
          <form action="{{ url('check/updateproducts')}}" method="POST" id="myForm">
              @csrf
              <h4 class="text-center mb-4">Товар приход</h4>
              ...
              <div class="input-group">
                ...
                <div class="input-group">
                  <label for="type" class="col-md-4 mt-2"
                    >Turi <span class="text-danger">*</span></label
                  >
                  <input
                    type="text"
                    id="type"
                  ...
                  <div class="input-group">
                    <label for="eni" class="col-md-4 mt-2"
                      >Eni <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      id="eni"
                  ...
                  <div class="input-group">
                    <label for="boyi" class="col-md-4 mt-2"
                      >Bo'yi <span class="text-danger">*</span></label
                    >
                    <input
                      type="text"
                      id="boyi"
              ...
              <div class="form-row mb-3">
                <div class="input-group">
                  <label for="metr-square" class="col-md-4 mt-2"
...
<script>
  function calculate(){
    ...
    var total= volume*perm2+volume*perm2*nds/100;
    $('#total').val(total);
  }
